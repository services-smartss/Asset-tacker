...
const en: Record<string, string> = {
  ...
  "ticket.queue.mine": "My site / assigned",
  "ticket.queue.mineHint": "Tickets assigned to you or your site department",
  "ticket.filter.allStatus": "All Status",
  "ticket.filter.allPriority": "All Priority",
  "ticket.site": "Site",
  "ticket.siteHint": "Routes the ticket to that site support team",
  "ticket.siteNone": "No site",
